...
def configured_realtime_turn_detection(session_payload: Mapping[str, Any]) -> tuple[str | None, object]:
...
def validate_realtime_turn_detection(session_payload: Mapping[str, Any]) -> str | None:
...
class TurnDetectionConfig:
    ...
    @classmethod
    def from_realtime(cls, turn_detection: Mapping[str, Any]) -> TurnDetectionConfig:
        return cls(
...
class PendingTurnDetectionUpdate:
    ...
    @classmethod
    def prepare(cls, session_payload: dict[str, Any]) -> PendingTurnDetectionUpdate | None:
